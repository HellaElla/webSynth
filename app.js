...
const delay = new Tone.FeedbackDelay({
    ...
    feedback: 0.5,   // Feedback amount (controls the number of echoes)
    wet: 0.5         // Wet signal amount (controls how much of the delay is mixed in)
}).toDestination();
...
function updateDelay() {
    const delayTime = parseFloat(document.getElementById('delayTimeSlider').value);
    const feedback = parseFloat(document.getElementById('delayFeedbackSlider').value);
    const wet = parseFloat(document.getElementById('delayWetSlider').value);
    ...
    document.getElementById('delayTimeValue').textContent = delayTime.toFixed(2);
    document.getElementById('delayFeedbackValue').textContent = feedback.toFixed(2);
    document.getElementById('delayWetValue').textContent = wet.toFixed(2);
}

document.getElementById('delayTimeSlider').addEventListener('input', updateDelay);
document.getElementById('delayFeedbackSlider').addEventListener('input', updateDelay);
document.getElementById('delayWetSlider').addEventListener('input', updateDelay);
